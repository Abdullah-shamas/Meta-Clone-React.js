    ...
    <>
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 flex justify-center items-center text-center bg-black/40">
          <h1 className="font-bold text-2xl sm:text-4xl md:text-5xl text-white px-4">
            Meta Quest 2S <br /> Unreal Device. Unreal Price
          </h1>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-7xl mx-auto px-6 py-16">
        {Product.map((p) => (
          ...
          >
            <img src={p.img} className="w-full h-48 object-cover" alt={p.description} />
            <p className="text-gray-600 mt-2 text-sm text-center px-2">{p.description}</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-gray-600 mt-6">
            ...
            etc.) from Meta about Meta’s existing and future products and services.
          </p>

          <p className="text-sm text-gray-600 mt-2">
            You may withdraw your consent and unsubscribe at any time by clicking the unsubscribe
            link included in our messages.
          </p>
        </div>
      </section>
    </>
