...
<section className="relative">
        ...
        <img className="w-full h-auto" src="https://lookaside.fbsbx.com/elementpath/media/?media_id=1241716707528391&version=1755086527&transcode_extension=webp"/>

    <div className="absolute items-center inset-0 flex justify-center text-center z-10">
        <h1 className="font-bold text-3xl text-white">Meta Quest 3S <br/> Unreal Device. Unreal Price</h1>
    </div>
</section>
